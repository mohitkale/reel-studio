...
const VISUAL_HINTS: Record<string, string> = {
  ...
  "hf-money-count": "Target amount (e.g. $10000 or 250%)",
  "hf-data-chart": "Chart title override (optional)",
  "hf-app-showcase": "CTA label on the showcase",
  "hf-logo-outro": "URL or domain pill",
  "hf-ig-follow": "Button label (optional)",
  "hf-tt-follow": "Button label (optional)",
  "hf-yt-lower-third": "Subscribe button label (optional)",
