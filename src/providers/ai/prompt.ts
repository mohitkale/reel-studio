...
export function buildPrompt(input: GeneratePlanInput): {
  ...
  const system = [
    ...
    "- For each scene pick templateId from: kinetic, lottie, three, stat-reveal, icon-grid, quote-card, emoji-punch, image-overlay.",
    ...
    "  • 'image-overlay': visually descriptive scenes that benefit from a photo backdrop.",
